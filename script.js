...
// nRandom serve per generare un numero casuale tra min e max che devono essere due numeri
function nRandom(max, min) {
  Math.floor(Math.random() * (max - min + 1) + min);
}

// spawnBombs serve per generare un numero(nBomb) di bombe e inserirle casualmente tra i x(nSquare) quadrati
